...
<div class="modal fade" id="exampleModal-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="qty_rusak" name="qty_rusak" placeholder="Masukkan jumlah barang rusak" min="0">
    </div>
  </div>
      ...
      <thead>
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>
  <form action="{{ route('pengembalian.destroy', ['id' => $item->id]) }}" method="post" class="delete-form">
    @method('delete')
    @csrf
    <input type="hidden" class="delete_id" value="{{ $item->id }}">
        ...
        $('.btndelete').click(function (e) {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/pengembalian/destroy/' + deleteid, // Make sure URL matches the route
                        data: data,
