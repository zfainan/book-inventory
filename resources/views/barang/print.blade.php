...
<body>
    <div class="kop-surat">
        <img src="{{ public_path('img/Logosmkypkk.png') }}" alt=" " style="max-width: 140px; position: absolute; left: 10px; top: 30px; right: 10px;">
        ...
        <p>Website: <a href="http://smkypkk1gamping.sch" class="blue-link">http://smkypkk1gamping.sch</a> Email: <a href="mailto:smkypkk1_gmp@yahoo.co.id" class="blue-link">smkypkk1_gmp@yahoo.co.id</a></p>
    </div>
